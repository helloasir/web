...
def index(request):
    return HttpResponse("Hello, Time now "+str(time)+" you are in noon click <a href=/>Home </a> or <a href=/weblist>weblist </a> or <a href=/noon >Noon </a> or <a href= page1 >Page1 </a> ")
